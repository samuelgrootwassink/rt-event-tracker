...
class TestNER(unittest.TestCase):
    ...
    def test_common_entity_sets(self):
        ...
        control_result = {frozenset({'dog', 'street', 'fox', 'leaf', 'red'}): 2.25, 
                          frozenset({'cat', 'street', 'fox', 'leaf', 'red'}): 1.5, 
                          frozenset({'car', 'tree', 'leaf', 'blue', 'pc'}): 1.25,
                          frozenset({'car', 'tree', 'blue', 'pc'}): 1.45}
        self.maxDiff = None
